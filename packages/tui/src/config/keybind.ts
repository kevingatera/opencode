...
export const Definitions = {
  ...
  agent_cycle: keybind("tab", "Next agent, or queue a typed prompt until the turn finishes"),
  ...
  prompt_queue: keybind("none", "Queue typed prompt until the turn finishes"),
  prompt_queue_edit: keybind("none", "Edit the next queued prompt"),
  prompt_queue_drop: keybind("none", "Drop the next queued prompt"),
...
export const CommandMap = {
  ...
  prompt_queue_drop: "prompt.queue.drop",
